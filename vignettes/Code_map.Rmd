...
visNetwork(network[[2]], network[[1]], width = "100%", height = "1000") %>% # Build the network
  ...
  visOptions(highlightNearest = list(enabled = TRUE, labelOnly = FALSE),    # Control highlighting when selecting script
             nodesIdSelection = TRUE) %>%                                   # Add drop down menu to highlight scripts
  
  ## Control colouring and highlighting per group
  
  visGroups(groupname = "bathymetry", shape = "dot", color = list(background = "#440154FF", border = "#440154FF", 
